...
class RadarDetectionComponent : public Component<LeadDataV3, RadarState, CarState>{
  public:
    bool Init() override;
    bool Proc(const std::shared_ptr<LeadDataV3>& camera_obj,
  ...
  private:
    // float seq_num;
    //publisher
    std::shared_ptr<apollo::cyber::Writer<RadarState>> writer_;
